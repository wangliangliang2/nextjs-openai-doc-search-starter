...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>interface com.qlive.linkmicservice.QAnchorHostMicHandler</p>
                <p>主播端连麦器</p>
</section>
...
<section class="rtc-doc-panel">
        ...
        <ul class="rtc-doc-catalogue">
                <li><a onClick='document.location.replace(`${document.location.protocol}//${document.location.host}${document.location.pathname}${document.location.search}#setMixStreamAdapter`)'>setMixStreamAdapter</a></li>
        </ul>
</section>
<div class="rtc-doc-page-wrap">方法</div>
<section class="rtc-doc-panel">
<div class="rtc-doc-page-title rtc-doc-antor" id="setMixStreamAdapter">setMixStreamAdapter</div>
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public void setMixStreamAdapter(@NotNull()
QLinkMicMixStreamAdapter QLinkMicMixStreamAdapter);</li>
    </li>
...
<ul class="rtc-doc-parameters">
    <li>
        <div>
            QLinkMicMixStreamAdapter: <a href='https://developer.qiniu.com/lowcode/api/12088/QLinkMicMixStreamAdapter'>QLinkMicMixStreamAdapter</a>
        </div>
                <p>混流适配器</p>
    </li>
</ul>
