...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>class im.floo.floolib.BMXMessage.MessageType</p>
                <p>消息类型</p>
</section>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final MessageType Single</li>
    </li>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final MessageType Group</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final MessageType System</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
public static im.floo.floolib.BMXMessage.MessageType[] values();</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static im.floo.floolib.BMXMessage.MessageType valueOf(java.lang.String name);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static MessageType swigToEnum(int swigValue);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
