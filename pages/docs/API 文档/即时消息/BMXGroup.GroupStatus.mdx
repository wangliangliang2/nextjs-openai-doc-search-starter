...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>class im.floo.floolib.BMXGroup.GroupStatus</p>
                <p>群组状态</p>
</section>
...
<section class="rtc-doc-panel">
        ...
        <ul class="rtc-doc-catalogue">
                ...
                <li><a onClick='document.location.replace(`${document.location.protocol}//${document.location.host}${document.location.pathname}${document.location.search}#Destroyed`)'>Destroyed</a></li>
        </ul>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final GroupStatus Normal</li>
    </li>
...
<section class="rtc-doc-panel">
<div class="rtc-doc-page-title rtc-doc-antor" id="Destroyed">Destroyed</div>
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final GroupStatus Destroyed</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
public static im.floo.floolib.BMXGroup.GroupStatus[] values();</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static im.floo.floolib.BMXGroup.GroupStatus valueOf(java.lang.String name);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static GroupStatus swigToEnum(int swigValue);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
