...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>class im.floo.floolib.BMXGroup.JoinAuthMode</p>
                <p>进群验证方式</p>
</section>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final JoinAuthMode Open</li>
    </li>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final JoinAuthMode NeedApproval</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final JoinAuthMode RejectAll</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
public static im.floo.floolib.BMXGroup.JoinAuthMode[] values();</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static im.floo.floolib.BMXGroup.JoinAuthMode valueOf(java.lang.String name);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static JoinAuthMode swigToEnum(int swigValue);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
