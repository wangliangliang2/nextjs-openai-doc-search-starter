...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>class im.floo.floolib.BMXPushService.PushDirection</p>
                <p>本地推送消息搜索方向</p>
</section>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final PushDirection Up</li>
    </li>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final PushDirection Down</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
public static im.floo.floolib.BMXPushService.PushDirection[] values();</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
    </div>
    <div class="rtc-doc-returns-title">Returns <span>PushDirection</span></div>
</li>
</ul>
</section>
<section class="rtc-doc-panel">
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static im.floo.floolib.BMXPushService.PushDirection valueOf(java.lang.String name);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static PushDirection swigToEnum(int swigValue);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
