...
<section class="rtc-doc-panel rtc-doc-describe rtc-doc-note">
                <p>class im.floo.floolib.BMXMessage.DeliveryQos</p>
                <p>消息投递质量</p>
</section>
...
<section class="rtc-doc-panel">
        ...
        <ul class="rtc-doc-catalogue">
                <li><a onClick='document.location.replace(`${document.location.protocol}//${document.location.host}${document.location.pathname}${document.location.search}#AtLastOnce`)'>AtLastOnce</a></li>
                <li><a onClick='document.location.replace(`${document.location.protocol}//${document.location.host}${document.location.pathname}${document.location.search}#AtMostOnce`)'>AtMostOnce</a></li>
                <li><a onClick='document.location.replace(`${document.location.protocol}//${document.location.host}${document.location.pathname}${document.location.search}#ExactlyOnce`)'>ExactlyOnce</a></li>
        </ul>
...
<section class="rtc-doc-panel">
<div class="rtc-doc-page-title rtc-doc-antor" id="AtLastOnce">AtLastOnce</div>
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final DeliveryQos AtLastOnce</li>
    </li>
...
<section class="rtc-doc-panel">
<div class="rtc-doc-page-title rtc-doc-antor" id="AtMostOnce">AtMostOnce</div>
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final DeliveryQos AtMostOnce</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<section class="rtc-doc-panel">
<div class="rtc-doc-page-title rtc-doc-antor" id="ExactlyOnce">ExactlyOnce</div>
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">public static final DeliveryQos ExactlyOnce</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
public static im.floo.floolib.BMXMessage.DeliveryQos[] values();</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static im.floo.floolib.BMXMessage.DeliveryQos valueOf(java.lang.String name);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
...
<ul class="rtc-doc-page-container">
        <li class="rtc-doc-sign-signature">
public static DeliveryQos swigToEnum(int swigValue);</li>
    </li>
<li class="rtc-doc-page-description">
    <div class="rtc-doc-desc-wrap">
        <p></p>
