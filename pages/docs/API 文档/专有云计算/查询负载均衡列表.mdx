...
# 请求路径
> `GET` /api/rio/v1/network/loadbalancer
...
```json
{
    "request_id":"HtPfEmkGlhtJyckW",
    "data":[
        {
            "load_balancer_id":"4de7c309-e772-4449-94c5-249a87f47206",
            "enabled":true,
            "load_balancer_name":"LB-7qGoa",
            "description":"",
            "flavor":{
            ...
            "vpc":{
                "private_ip_address":"192.168.11.22",
                "vpc_id":"35c11b0f-f9e8-4b9d-9e7f-d438f14d713c",
                "vpc_name":"QVM",
                "v_switch_id":"430ca45c-20d5-4c29-ada4-85379a2e6291",
                "v_switch_name":"QVM",
                "eip_info":{
                    "eip_id":"a478dc58-3989-4eda-8ffe-8e2cb808558a",
                    "eip_name":"flow_test",
                    "ip_address":"122.228.235.36",
                    "bandwidth":100
                }
            },
            "create_at":1640762695000,
            "listeners":[
