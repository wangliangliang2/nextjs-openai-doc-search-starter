 ...
 * 可视化图表类型新增支持统计地图（目前支持中国地图）、数字单值图、仪表单值图。【[使用文档](/insight/manual/4859/the-report-shows#2)】

 * [指标支持变化率](/insight/manual/4859/the-report-shows#2)：对指标的平均值、最大值、最小值、总和再统计变化率。

 * [对 long 类型的分组字段支持设置分组方式](/insight/manual/4859/the-report-shows#2)，包括按字段值分组、按指定间隔分组、自定义间隔分组。

 * 支持[上下文搜索](/insight/manual/4870/context-query) 功能。
