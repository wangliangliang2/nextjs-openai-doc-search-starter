...
1. 仪表盘功能上线，支持将图表保存到仪表盘进行统一管理。【[使用文档](/insight/manual/4867/the-dashboard)】

2. 异常检测预测功能上线，支持对历史时序数据进行智能异常检测，不需要再配置阈值，提高生产力。【[说明文档](/insight/manual/4705/anomaly-detection)】【[使用场景](/insight/manual/4707/ml-scenario-analysis)】

3. 对历史数据自学习，进行数据指标预测。【[说明文档](/insight/manual/4611/prediction)】【[使用场景](/insight/manual/4707/ml-scenario-analysis#3)】
...
点击`创建图表`或者页面右侧的添加图表 icon，进入图表配置页面，配置图表参考[配置报表](/insight/manual/4859/the-report-shows#2)。
...
![](https://pandora-kibana.qiniu.com/release_ml.png)
...
![](https://pandora-kibana.qiniu.com/ml_forecast.png)

3. 预测结果包括预测指标区间以及预测指标值。

![](https://pandora-kibana.qiniu.com/ml_forecast_detail.png)