...
2.上传文件名为 butterfly.mp4，则转码后文件名为 butterfly-transcode.mp4；上传文件名 newcity.flv，则转码后文件名为 newcity-transcode.flv
...
|支持的操作方式|参考文档|
|-|-|
|控制台	|[设置转码样式](/kodo/development_guidelines/8559/set-the-transcoding-style)|
