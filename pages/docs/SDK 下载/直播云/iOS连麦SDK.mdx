...
| 使用场景 | 下载地址 |
| ---- | ---- |
| 真机 | [PLMediaStreamingKit_v2.3.1.1.zip](http://sdk-release.qnsdk.com/PLMediaStreamingKit_v2.3.1.1.zip) |
| 真机 + 模拟器 | [PLMediaStreamingKit_v2.3.1.1_universal.zip](http://sdk-release.qnsdk.com/PLMediaStreamingKit_v2.3.1.1_universal.zip) |
...
<a id="7"></a>
# 7 历史记录
- [2.2.4.1](http://sdk-release.qnsdk.com/PLMediaStreamingKit_v2.2.4.1.zip)
- 缺陷
    - 修复 iPhone 8 系列无视频数据回调的问题
    - 修复 iOS 11 设备上预览启动慢的问题
    - 修复 iPhone X 设备上出现的 crash 问题
    
- [2.2.1.7](http://oaccf377t.bkt.clouddn.com/PLMediaStreamingKit_v2.2.1.7.zip)
- 功能
...
- [2.2.1.3](http://oaccf377t.bkt.clouddn.com/PLMediaStreamingKit_v2.2.1.3.zip)
- 缺陷
  - 修复 iPhone 7 Plus 上偶现的崩溃的问题；
  - 修复某些机型连麦过程中使用 siri 后有噪音的问题；

- [2.2.0.2](http://oaccf377t.bkt.clouddn.com/PLMediaStreamingKit_v2.2.0.2.zip)
  - 功能
...
- [2.1.6.1](http://oaccf377t.bkt.clouddn.com/PLMediaStreamingKit__v2.1.6.1.zip)
  - 功能
    - 支持苹果 ATS 安全标准；
